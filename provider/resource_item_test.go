		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExampleItemExists("apex_example_item.test_item"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_item", "name", "test"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_item", "description", "hello"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_item", "tags.#", "2"),
					resource.TestCheckResourceAttr("apex_example_item.test_item", "tags.1931743815", "tag1"),
					resource.TestCheckResourceAttr("apex_example_item.test_item", "tags.1477001604", "tag2"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExampleItemExists("apex_example_item.test_update"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "name", "test_update"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "description", "hello"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "tags.#", "2"),
					resource.TestCheckResourceAttr("apex_example_item.test_update", "tags.1931743815", "tag1"),
					resource.TestCheckResourceAttr("apex_example_item.test_update", "tags.1477001604", "tag2"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "name", "test_update"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "description", "updated description"),
					resource.TestCheckResourceAttr(
						"apex_example_item.test_update", "tags.#", "2"),
					resource.TestCheckResourceAttr("apex_example_item.test_update", "tags.1931743815", "tag1"),
					resource.TestCheckResourceAttr("apex_example_item.test_update", "tags.1477001604", "tag2"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckExampleItemExists("apex_example_item.test_item"),
					testAccCheckExampleItemExists("apex_example_item.another_item"),
				),
			},
		},
	})
...
func testAccCheckItemUpdatePre() string {
	return fmt.Sprintf(`
resource "apex_example_item" "test_update" {
  name        = "test_update"
  description = "hello"
...
resource "apex_example_item" "another_item" {
	name        = "another_test"
	description = "hello"
